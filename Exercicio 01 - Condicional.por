...
//João precisa que você faça um sistema que leia a variável P (peso de tomates) e verifique se há excesso. Se houver, gravar na variável E (Excesso) e na variável M o valor 
...
programa
{
	...
	escreva("Insira o peso de tomate trazido:")
	leia(P)

		se (P<= 50){
			escreva("\n O Excesso é de ZERO, logo a multa é ZERO.")
			...
			escreva("\n O excesso é de: " + E + " quilos." + " Logo, a multa é equivalente a: " + M + " reais.")
